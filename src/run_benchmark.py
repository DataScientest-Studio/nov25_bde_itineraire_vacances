...
plot_size_comparison(
    results["size_comparison"], save_path="../data/graphs/size_comparison.png"
)

plot_stability(
    results["stability_ga"], "ga", save_path="../data/graphs/stability_ga.png"
)

plot_order_stability(
    results["stability_ga"], "ga", save_path="../data/graphs/order_stability_ga.png"
)

plot_stability(
    results["stability_nn2o"], "nn2o", save_path="../data/graphs/stability_nn2o.png"
)
