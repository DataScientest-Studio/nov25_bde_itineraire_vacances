...
DATATOURISME_URL = "https://www.data.gouv.fr/fr/datasets/r/5eb5139a-5b6d-4767-9372-2d244675543c"
...
def extract_datatourisme():
    ...
    output_path = RAW_DIR / "datatourisme" / f"datatourisme_{datetime.now().strftime('%Y%m%d')}.csv"
