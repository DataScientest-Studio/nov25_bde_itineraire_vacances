...
# Palette de couleurs pour les jours
COLORS = [
...
transport_mode = st.session_state.payload["transport_mode"]
index = list(st.session_state.dict_mobility.values()).index(
    st.session_state.payload["transport_mode"]
)
...
for day in range(0, len(itinerary_list)):
    ...
    day_total_distance = itinerary[0]["day_total_distance_km"]
    day_total_duration = itinerary[0]["day_total_duration_min"]
                    ...
                    if i == 0:
                        ...
                        st.markdown(
                            f"""
                                    ...
                                    <small>- Description: {itinerary[i]['description']}</small><br>
                                    <small>- Adresse: {itinerary[i]['adresse']}</small><br>
                                    <small>- Contact téléphone: <a href="{itinerary[i]['contact_phone']}" target="_blank">{itinerary[i]['contact_phone']}</a></small>
                                    <small>- Contact mail: <a href="{itinerary[i]['contact_mail']}" target="_blank">{itinerary[i]['contact_mail']}</a></small>
                                    <small>- Website: <a href="{itinerary[i]['contact_website']}" target="_blank">{itinerary[i]['contact_website']}</a></small>
                                    </div>
                                    """,
                        )
                    else:
