        ...
        derived = pl.DataFrame(
            {
                ...
                "cum_total_duration_min": pl.Series(
                    "cum_total_duration_min", cum_total, dtype=pl.Float64
                ),
                "day_total_distance_km": pl.Series(
                    "day_total_distance_km", [total_d] * len(poi_order), dtype=pl.Float64
                ),
                "day_total_duration_min": pl.Series(
